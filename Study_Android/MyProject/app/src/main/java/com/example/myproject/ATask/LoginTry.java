...
public class LoginTry extends AsyncTask<Void, Void, Void> {
    String id, passwd;

    public LoginTry(String id, String passwd) {
        this.id = id;
        this.passwd = passwd;
    }
    ...
    private MemberDTO readMessage(InputStream inputStream) throws Exception {
